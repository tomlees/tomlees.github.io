...
let starRed = ["blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "red", "red","red","red","red","red","red","red","red","red","red","red", "red", "red", "red", "red","red","red","red","red","red","red","red","red","red", "red", "red"]
let starWhite = ["red", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "blue", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white", "white"]
let usa = []
for (var i = 0; i < 3; i++) {
  usa = usa.concat(starRed)
  usa = usa.concat(starRed)
usa = usa.concat(starWhite)
usa = usa.concat(starWhite)
}
for (var i = 0; i < 6; i++) {
  for (var i2 = 0; i2 < 2; i2++) {
    for (var i3 = 0; i3 < 51; i3++) {
      usa.push("red")
    }
  }
  for (var i2 = 0; i2 < 2; i2++) {
...
let patterns = [usa, pattern1, pattern2, pattern3, pattern4]
let cp = 0
let cpl = 0
let cPattern = 0
let usaNow = false
...
;(function update (time) {
  ...
  if (usaNow == true) {
  document.getElementById("directions").innerHTML = "Drag with your mouse, right-click to slice. Original pen by Dissimulate. You can't rip the american flag"
  }
  else {
  document.getElementById("directions").innerHTML = "Drag with your mouse, right-click to slice. Original pen by Dissimulate"
  }
